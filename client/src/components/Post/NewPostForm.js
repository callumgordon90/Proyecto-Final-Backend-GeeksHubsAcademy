                ...
                <>
                    <div className='data'>
                        <p>
                            ...
                            Following{userData.following && userData.following.length > 1
                                ? "s" : null}
                        </p>
                        <p>
                            <span>{userData.followers ? userData.followers.length : 0}
                            </span>{""}
                            Followers{userData.followers && userData.followers.length > 1
                                ? "s" : null}
                        </p>
                    </div>
                    ...
                    <div className='post-form'>
                                    ...
                                    <div className='content'>
                                        ...
                                        {video && (
                                            <iframe
                                                ...
                                                encrypted-media; gyropscope; picture-in-picture"
                                                allowFullScreen
                                                title={video}
                                            ></iframe>
                                        )}
                        ...
                        <div className='footer-form'>
                            <div className='icon'>
                                {isEmpty(video) && (
                                    <>
                                        <img src=".img/iconspicture.svg" alt="img" />
                                        <input type="file"
                                            id="file-upload"
                                            name="file"
                                            accept=".jpg, .jpeg, .png"
                            ...
                            <div className="btn-send">
                                {message || postPicture || video.length > 20 ? (
                                    ...
                                    <button className="cancel" onClick={cancelPost}>Delete Message</button>
                                ) : null}
